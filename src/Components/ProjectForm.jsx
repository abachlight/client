  ...
  return (
    <div >
        <div>
            ...
            <div>
                <h3>Project</h3>
                <p className='text-sm'>Add your project</p>
            </div>
            <button type="button" onClick={addProject} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700
                ...
                {data.map((project, index)=>(
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid gap-3'>
                            ...
                            type='text' placeholder='Project Name' className="px-3 py-2 text-sm rounded-lg hover:bg-gray-200 transition-colors"/>

                            <input value={project.type || ""} onChange={(e)=>updateProject(index, "type", e.target.value)} 
                            type='text' placeholder='Project Type' className="px-3 py-2 text-sm rounded-lg hover:bg-gray-200 transition-colors"/>
