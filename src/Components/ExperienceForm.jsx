...
const generateDescription = async (index) => {
    ...
    try {
        const { data } = await api.post('api/ai/enhance-job-desc', {userContent:
    ...
    <div className='space-y-6'>
        <div>
            ...
            <div>
                ...
                <p className='text-sm'>Add your job experience</p>
            </div>
            <button onClick={addExperience} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700
                ...
                {data.map((experience, index)=>(
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        <div className='flex justify-between items-start'>
                            ...
                            <button onClick={()=> removeExperience(index)} className='text-red-500 hover:text-red-700 transition-color'>
                        ...
                        <div className='grid md:grid-cols-2 gap-3'>
                            ...
                            type='month' disabled={experience.is_current} className='px-3 py-2 text-sm rounded-lg disable:bg-gray-100'/>
                        </div>
                        ...
                        <label className='flex items-center gap-2'>
                            <input type='checkbox' checked={experience.is_current || false}
                             onChange={(e)=>{updateExperience(index, "is_current", e.target.checked ? true : false); }} 
                              className='rounded border-gray-300 text-blue-600 focus:ring-blue-blue-500'/>
                        ...
                        <div className='space-y-2'>
                            <div className='flex items-center justify-between'>
                                ...
                                disabled={generatingIndex === index || !experience.position || !experience.company} className='flex items-center
                                 gap-1 px-2 py-1 text-xs bg-purple-100 text-purple-700
